...
public class PDFGStateStack {
    ...
    public void gsave()
    {
        _gstates.add(_gstate = _gstate.clone());
    }
    ...
    {
        return _gstate.fillOpacity;
    }

    /**
     * Sets the fill opacity.
     */
    public void setFillOpacity(double anOpacity)
    {
        _gstate.fillOpacity = anOpacity;
    }
    ...
    {
        return _gstate.strokeOpacity;
    }

    /**
     * Sets the stroke opacity.
     */
    public void setStrokeOpacity(double anOpacity)
    {
        _gstate.strokeOpacity = anOpacity;
    }
    ...
    {
        return _gstate.shapeOpacity;
    }

    /**
     * Sets the shape opacity.
     */
    public void setShapeOpacity(double anOpacity)
    {
        _gstate.shapeOpacity = anOpacity;
    }
