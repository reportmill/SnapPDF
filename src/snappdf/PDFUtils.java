...
public class PDFUtils {
    ...
    public static byte[] bytesForASCIIHex(String hstring)
    {
        ...
        // this should never happen
            ...
            throw new PDFException("Couldn't convert string to ascii");
        }
    }
    ...
    public static byte[] getBytesDecoded(byte bytes[], int offset, int length, String aFilter, Map params)
    {
        ...
        // Handle ASCII85
            ...
            decoded = PDFUtils.bytesForASCII85(bytes, offset, length);

            // Handle ASCIIHex
        else if (aFilter.equals("/ASCIIHexDecode"))
            decoded = PDFUtils.bytesForASCIIHex(bytes, offset, length);
